<?php
// ============================================================
// PJU MONITORING - MANAJEMEN TIANG (NODE)
// ============================================================
...
<body class="min-h-screen bg-slate-50 text-slate-800">
    ...
    <main class="mx-auto max-w-7xl px-5 py-6 space-y-6">
        <div>
            ...
            <p class="text-sm text-slate-500">Tambah, ubah, atau nonaktifkan tiang beserta koordinat lokasinya.</p>
        </div>
        ...
        <section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <form id="formAdd" class="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
                <div><label class="mb-1 block text-[11px] font-bold text-slate-500">ID Node *</label>
                    <input name="node_id" required placeholder="pju04" class="w-full rounded-xl border border-slate-300 bg-slate-50 px-3 py-2 text-sm outline-none focus:border-sky-500 focus:bg-white"></div>
